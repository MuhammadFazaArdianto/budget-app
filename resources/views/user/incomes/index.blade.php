    ...
    <div class="card w-100">
      <div class="card-body">
        <div class="d-md-flex align-items-center">
            <div>
                <h4 class="card-title">Income User</h4>
            </div>
                          ...
                          @foreach($data as $index => $item)
                            <tr>
                              ...
                              <td>
                                ...
                                <form id="deleteForm_{{ $item->id }}" action="{{ route('user.incomes.delete', $item->id) }}" method="POST" style="display:inline">
                                    @csrf @method('DELETE')
...
<div class="modal fade" id="addModal" tabindex="-1">
    <div class="modal-dialog">
      <form method="POST" action="{{ route('user.incomes.store') }}">
        @csrf
          ...
          <div class="modal-body">
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="date" name="tgl_pemasukan" class="form-control" required>
              </div>
              <div class="mb-3">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                <label class="form-label">Tanggal Pemasukan</label>
                <input type="date" name="tgl_pemasukan" id="edit_tgl_pemasukan" class="form-control" required>
              </div>
              <div class="mb-3">
                <label class="form-label">Keterangan</label>
  ...
  <script>
    ...
    function editIncome(data) {
      $('#editForm').attr('action', '/dashboard-incomes/update/' + data.id);
      $('#edit_id').val(data.id);
      $('#edit_kategori').val(data.kategori);
      $('#edit_jumlah').val(data.jumlah);
      $('#edit_tgl_pemasukan').val(data.tgl_pemasukan);
